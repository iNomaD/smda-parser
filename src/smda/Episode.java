...
/**
 * Cache' Java Class Generated for class smda.Episode on version Cache for Windows (x86-64) 2015.2.1 (Build 705U_SU) Tue Sep 1 2015 09:00:45 EDT.<br>
 *
...
public class Episode extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 4318;
   ...
   */
    ...
    */
    ...
    public static void checklistOfAnalysisValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
       Returns value of property <code>listOfAnalysis</code>.
       <Description>
       @return current value of <code>listOfAnalysis</code> represented as
       <code>java.util.List</code>

       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://Denis-PC:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=DENIS&CLASSNAME=smda.Episode#listOfAnalysis"> listOfAnalysis</A>
    */
    public java.util.List getlistOfAnalysis()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("listOfAnalysis",true);
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     <p>Runs method listOfAnalysisGetObject in Cache.</p>
     default argument force set to 0
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see #listOfAnalysisGetObject(java.lang.Integer)
     @see <a href = "http://Denis-PC:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=DENIS&CLASSNAME=smda.Episode#listOfAnalysisGetObject"> Method listOfAnalysisGetObject</A>
    */
    public com.intersys.objects.Oid listOfAnalysisGetObject () throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[0];
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("listOfAnalysisGetObject",args,com.intersys.objects.Database.RET_PRIM);
        return res.getOid();
    }
    /**
     <p>Runs method listOfAnalysisGetObject in Cache.</p>
     ...
     @see <a href = "http://Denis-PC:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=DENIS&CLASSNAME=smda.Episode#listOfAnalysisGetObject"> Method listOfAnalysisGetObject</A>
    */
    public com.intersys.objects.Oid listOfAnalysisGetObject (java.lang.Integer force) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
    ...
    /**
     <p>Runs method listOfAnalysisGetObjectId in Cache.</p>
     default argument force set to 0
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see #listOfAnalysisGetObjectId(java.lang.Integer)
     @see <a href = "http://Denis-PC:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=DENIS&CLASSNAME=smda.Episode#listOfAnalysisGetObjectId"> Method listOfAnalysisGetObjectId</A>
    */
    public java.lang.String listOfAnalysisGetObjectId () throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[0];
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("listOfAnalysisGetObjectId",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method listOfAnalysisGetObjectId in Cache.</p>
     ...
     @see <a href = "http://Denis-PC:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=DENIS&CLASSNAME=smda.Episode#listOfAnalysisGetObjectId"> Method listOfAnalysisGetObjectId</A>
    */
    public java.lang.String listOfAnalysisGetObjectId (java.lang.Integer force) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(force);
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("listOfAnalysisGetObjectId",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    ...
    /**
     <p>Runs method listOfAnalysisIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param value represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://Denis-PC:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=DENIS&CLASSNAME=smda.Episode#listOfAnalysisIsValid"> Method listOfAnalysisIsValid</A>
    */
    public static void listOfAnalysisIsValid (com.intersys.objects.Database db, java.lang.String value) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(value);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"listOfAnalysisIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     <p>Runs method listOfAnalysisSetObject in Cache.</p>
     @param newvalue represented as com.intersys.objects.Oid
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://Denis-PC:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=DENIS&CLASSNAME=smda.Episode#listOfAnalysisSetObject"> Method listOfAnalysisSetObject</A>
    */
    public void listOfAnalysisSetObject (com.intersys.objects.Oid newvalue) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(newvalue);
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("listOfAnalysisSetObject",args,com.intersys.objects.Database.RET_PRIM);
        getDatabase().parseStatus(res);
        return;
    }
    /**
     <p>Runs method listOfAnalysisSetObjectId in Cache.</p>
     @param newid represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://Denis-PC:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=DENIS&CLASSNAME=smda.Episode#listOfAnalysisSetObjectId"> Method listOfAnalysisSetObjectId</A>
    */
    public void listOfAnalysisSetObjectId (java.lang.String newid) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(newid);
        com.intersys.cache.Dataholder res=mInternal.runInstanceMethod("listOfAnalysisSetObjectId",args,com.intersys.objects.Database.RET_PRIM);
        getDatabase().parseStatus(res);
        return;
    }
    /**
    ...
    */
    ...
    public static Object addToBatchInsert (Object batch, java.sql.Connection con, String cos_EpisodeNumber) throws java.sql.SQLException {
        if (batch == null) {
        ...
        com.intersys.jdbc.SysListProxy.setUndefined(qbatch.list); // for listOfAnalysis
